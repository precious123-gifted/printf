#include "main.h"
/**
 * Peforms cleanup operations for _printf.
 * A va_list of arguments provided to _printf.
 ...
 *Description: This function makes loop to string pointer
 *Return: numbers of characteres printed
 */
